function Projects({title, description, imageLink, gitHubLink, reverse}) {
    return (
        <div className={(reverse ? 'md:flex md:flex-row-reverse ' : 'md:flex md:flex-row ') + 'h-[80vh] border-t-4 border-[#E0E0E0] rounded-4xl'}>
            <img src={imageLink} alt={title} className='m-auto md:max-w-[75vh]  md:max-h-[60vh] rounded-2xl border-r-2 border-b-2 object-contain'/>
